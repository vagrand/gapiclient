...
class Instance implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'name' => 'string',
        'config' => '\GenericApi\Client\Model\InstanceConfig'
    ];
     ...
     * Sets code
     *
     * @param string $code Уникальный алфавитно-цифровой идентификатор, который присваевается инстансу после успешной установки связи с источником
     *
     * @return $this
     */
     ...
     * Gets config
     *
     * @return \GenericApi\Client\Model\InstanceConfig
     */
     ...
     * Sets config
     *
     * @param \GenericApi\Client\Model\InstanceConfig $config config
     *
     * @return $this
     */
